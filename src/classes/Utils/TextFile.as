package classes.Utils
{
	...
	public class TextFile
	{
		...
		private static var file:File = File.documentsDirectory.resolvePath(Globals.LOG_FILE_PATH);
		...
		public static function read(startIndex:int = 0,endIndex:int = int.MAX_VALUE):String
		{
			var results:String;
			//var file:File = new File(target_url);
			var fs:FileStream = new FileStream();
		...
		public static function log(operationCode:String, operationName:String, operationDescription:String):void
		{
			var logRecord:String = 
				Globals.CurrentDateTimeWithMinutesSecondsString() + ";" + 	// Operation Date/Time
				Globals.USE_CODE + ";" + 									// Use Code
				Globals.VERSION_NUMBER + ";" + 								// Version Number
		...
		public static function update(value:String,startIndex:int = 0):void
		{
			//var file:File = new File(target_url);
			var fs:FileStream = new FileStream();
